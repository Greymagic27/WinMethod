...
/// A {@link Pointer} to a constant null-terminated string of 16-bit Unicode characters
public class LPCWSTR extends Pointer {
    /// Creates a pointer from a memory segment
    ///
    /// @param segment The memory segment to wrap
    public LPCWSTR(MemorySegment segment) {
        super(segment);
    }
